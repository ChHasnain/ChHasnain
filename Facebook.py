...
\33[38;1m03118123291
\33[38;1mLoaded....100%
\033[0;35m[\033[0;92m •• \033[0;35m] Author   : ChHasnain
...
\33[31;1m░C░H░H░A░S░N░A ░I░N░H░A░C░K░E░R░
...
\033[0;39m~~~~~~~~~~~~~~~~~~~~~~~~~~~"""
print("\033[0;92mUsername/Password: ChHasnain adiha12")
print("\033[0;39m~~~~~~~~~~~~~~~~~~~~~~~~~~~")

CorrectUsername = "ChHasnain"
CorrectPassword = "adiha12"


loop = 'true'
while (loop == 'true'):
    username = raw_input("\033[0;39m\x1b[0;39mUsername ➣ \x1b[0;39m ")
    if (username == CorrectUsername):ChHasnain
    	password = raw_input("\033[0;39m\x1b[0;39mPassword ➣ \x1b[0;39m ")
        if (password == CorrectPassword):adiha12
